#!/usr/bin/env bash
# =============================================================================
# Scenario: Benign - DNS cache flush
# =============================================================================
# MITRE ATT&CK: T1059
# Tactic:     Execution
# Severity:   LOW (vendor-reported; Vyrox re-triages independently)
#
# Help desk flushing the DNS cache while troubleshooting connectivity. Routine.
#
# Expected Vyrox verdict: BENIGN/LOW.
# =============================================================================

SCENARIO_NAME="low_dns_flush"
    ...
    cat <<EOF
{
    ...
    "timestamp": ${TIMESTAMP},
    "sensor": {
        "hostname": "win-helpdesk-02"
    },
    "process": {
        "user_name": "CORP\\\\helpdesk",
        "file_name": "ipconfig.exe",
        "command_line": "ipconfig /flushdns",
